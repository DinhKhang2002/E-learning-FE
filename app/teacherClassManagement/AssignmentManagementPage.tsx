...
export default function AssignmentManagementPage({
  ...
  const canPreviewInBrowser = (fileType: string) => {
    ...
    return previewableTypes.some((type) => fileType.toLowerCase().includes(type.split("/")[1]));
  };
          ...
          <>
            ...
            >
              <div className="relative w-full max-w-6xl bg-white rounded-3xl shadow-2xl border border-slate-200 overflow-hidden max-h-[95vh] flex flex-col">
                {/* Header */}
                <div className="flex items-center justify-between p-6 border-b border-slate-200 bg-gradient-to-r from-pink-50 to-rose-50">
                  <div className="flex items-center gap-3 flex-1 min-w-0">
                    <File className="w-6 h-6 text-pink-600 flex-shrink-0" />
                    <div className="flex-1 min-w-0">
                  ...
                  {fileLoading ? (
                    ...
                    <div className="flex flex-col items-center justify-center h-full min-h-[400px] p-8">
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-pink-600 to-rose-600 text-white rounded-xl font-semibold hover:from-pink-700 hover:to-rose-700 transition-all shadow-lg hover:shadow-xl"
                      >
