...
export default function HomePage() {
  ...
  return (
    <main
      id="home"
      className="flex flex-col min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-black overflow-x-hidden"
    >
      <Navbar />
      ...
      <div className="fixed inset-0 -z-20 pointer-events-none">
        <div className="absolute top-32 left-1/4 w-96 h-96 bg-purple-600 rounded-full filter blur-3xl opacity-10 animate-pulse" />
        <div className="absolute bottom-32 right-1/4 w-96 h-96 bg-pink-600 rounded-full filter blur-3xl opacity-10 animate-pulse delay-1000" />
      </div>
    </main>
  );
}
